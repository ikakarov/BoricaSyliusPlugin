...
namespace Vanssa\BoricaSyliusPlugin\Payum\Borica;
...
class Response
{
    ...
    public function __construct($publicCertificate=false, $useFileKeyReader = false)
    {
    ...
    protected function is_demo(array $config): bool
    {
        return (isset($config['has_demo']) AND $config['has_demo']);
    }
    ...
    public function setConfig(array $config):? self
    {
        ...
        $this->publicCertificate = $this->is_demo($config) ? $config['borica_test_certificate']:$config['borica_real_certificate'];
        return $this;
    }
