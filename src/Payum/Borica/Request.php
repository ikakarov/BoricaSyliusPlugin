...
use Vanssa\BoricaSyliusPlugin\Exceptions\InvalidParameterException;
use Vanssa\BoricaSyliusPlugin\Exceptions\LengthException;
...
class Request
{
    ...
    public function __construct($terminalID, $privateKey,  $debug = true, $privateKeyPassword = '', $language = 'En',$useFileKeyReader = false)
    {
